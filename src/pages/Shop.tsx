      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-gray-500 text-sm">
            {filtered.length} frame{filtered.length !== 1 ? "s" : ""} available
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="relative flex-1 min-w-0">
            <Search
              size={18}
              className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-gray-400 flex-shrink-0"
            />
            <input
              type="text"
              ...
              className="w-full pl-9 sm:pl-11 pr-10 sm:pr-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border border-gray-200 bg-white focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 text-xs sm:text-sm transition-all"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
                className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 flex-shrink-0 p-1"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {activeFilterCount > 0 && (
                <button
                  ...
                  className="text-xs text-teal font-medium hover:text-teal-dark"
                >
                  Clear all
                </button>
              )}
        ...
        {filtered.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <button
              onClick={clearFilters}
              className="px-5 py-2.5 bg-teal text-white text-sm font-medium rounded-full hover:bg-teal-dark transition-colors"
            >
              Clear All Filters
            </button>
          </div>
